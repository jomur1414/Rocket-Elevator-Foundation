...
class GeolocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geolocation" do
    assert_difference('Geolocation.count') do
      post geolocations_url, params: { geolocation: { latitude: @geolocation.latitude, longitude: @geolocation.longitude, name: @geolocation.name } }
    end
  ...
  test "should update geolocation" do
    patch geolocation_url(@geolocation), params: { geolocation: { latitude: @geolocation.latitude, longitude: @geolocation.longitude, name: @geolocation.name } }
